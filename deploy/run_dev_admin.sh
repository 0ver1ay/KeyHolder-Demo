#!/usr/bin/env bash
# Запуск AdminApp из исходников (без PyInstaller).
# Первый раз: bash deploy/run_dev_admin.sh  (сам создаст .venv и поставит зависимости)
...
echo "==> Starting AdminApp (python main_admin.py)..."
exec python main_admin.py
